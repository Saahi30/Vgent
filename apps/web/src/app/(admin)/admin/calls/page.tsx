...
export default function AdminCallsPage() {
  ...
  // Client-side status filter (API may not support status param for admin calls)
  const filteredCalls =
    statusFilter === "all"
      ? calls
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Call history across all tenants
          </p>
        </div>
      </div>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-muted-foreground text-sm">
                Calls will appear here once tenants start making them.
              </p>
            </div>
          ) : (
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {filteredCalls.map((call: any) => {
                    const tenantName =
                      tenants.find((t: any) => t.id === call.tenant_id)?.name ||
                      call.tenant_name ||
                      call.tenant_id?.slice(0, 8) ||
                      "--";
                    return (
                      <tr
                        key={call.id}
